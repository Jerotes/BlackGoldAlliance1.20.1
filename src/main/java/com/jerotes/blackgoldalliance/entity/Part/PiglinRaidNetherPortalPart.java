...
public class PiglinRaidNetherPortalPart extends PartEntity<PiglinRaidNetherPortalEntity> {
	public final PiglinRaidNetherPortalEntity parentMob;
	public final String name;
	private final EntityDimensions size;

	public PiglinRaidNetherPortalPart(PiglinRaidNetherPortalEntity parent, String p_31015_, float p_31016_, float p_31017_) {
		super(parent);
	...
	public boolean canCollideWith(Entity entity) {
		if (entity instanceof PiglinRaidNetherPortalEntity) {
			return false;
		}
		return this.getParent() != null && this.getParent().isAlive() && !(entity instanceof LivingEntity livingEntity && EntityFactionFind.isFaction(this.getParent(), livingEntity));
	}
	@Override
