...
public class OtherPacketHandler {
	...
	public static final SimpleChannel NETWORK_WRAPPER = NetworkRegistry.newSimpleChannel(
			new ResourceLocation(BGA.MODID, "main"),
			() -> PROTOCOL_VERSION,
	...
	public static void register() {
		...
		NETWORK_WRAPPER.registerMessage(packetsRegistered++, BGAPlayerData.PlayerVariablesSyncMessage.class,
				BGAPlayerData.PlayerVariablesSyncMessage::encode,
				BGAPlayerData.PlayerVariablesSyncMessage::decode,
				BGAPlayerData.PlayerVariablesSyncMessage::consume,
