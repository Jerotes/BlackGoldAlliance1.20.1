...
public class Modelblack_gold_warrior_armor extends HumanoidModel<LivingEntity> {
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(BGA.MODID, "black_gold_warrior_armor"), "main");
	...
	public Modelblack_gold_warrior_armor(ModelPart root) {
		super(root);
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head_r1 = head.addOrReplaceChild("head_r1", CubeListBuilder.create().texOffs(24, 0).addBox(-4.0F, -2.0F, 0.0F, 8.0F, 4.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -11.5F, 5.5F, -0.3927F, 0.0F, 0.0F));

		PartDefinition horn = head.addOrReplaceChild("horn", CubeListBuilder.create(), PartPose.offset(0.0F, -10.0637F, 0.4449F));

		PartDefinition horn_r1 = horn.addOrReplaceChild("horn_r1", CubeListBuilder.create().texOffs(64, 11).addBox(-1.5F, -1.5F, -4.0F, 3.0F, 2.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-5.75F, 3.3137F, -0.1949F, 0.1309F, -0.1745F, -0.0698F));

		PartDefinition horn_r2 = horn.addOrReplaceChild("horn_r2", CubeListBuilder.create().texOffs(64, 11).mirror().addBox(-1.5F, -1.5F, -4.0F, 3.0F, 2.0F, 7.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(5.75F, 3.3137F, -0.1949F, 0.1309F, 0.1745F, 0.0698F));
		...
		PartDefinition horn_r3 = horn.addOrReplaceChild("horn_r3", CubeListBuilder.create().texOffs(78, 0).addBox(-1.5F, -3.5F, 2.0F, 3.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
				.texOffs(64, 0).addBox(-1.5F, -1.5F, -4.0F, 3.0F, 3.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-6.25F, 0.3137F, -0.4449F, 0.4363F, -0.1745F, -0.0698F));
		...
		PartDefinition horn_r4 = horn.addOrReplaceChild("horn_r4", CubeListBuilder.create().texOffs(64, 0).mirror().addBox(-1.5F, -1.5F, -4.0F, 3.0F, 3.0F, 8.0F, new CubeDeformation(0.0F)).mirror(false)
				.texOffs(78, 0).mirror().addBox(-1.5F, -3.5F, 2.0F, 3.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(6.25F, 0.3137F, -0.4449F, 0.4363F, 0.1745F, 0.0698F));
		...
		PartDefinition jacket_r1 = jacket.addOrReplaceChild("jacket_r1", CubeListBuilder.create().texOffs(64, 20).addBox(-4.0F, -6.0F, -2.0F, 8.0F, 7.0F, 4.0F, new CubeDeformation(1.1F)), PartPose.offsetAndRotation(0.0F, 5.25F, 0.25F, 0.0436F, 0.0F, 0.0F));

		PartDefinition jacket_r2 = jacket.addOrReplaceChild("jacket_r2", CubeListBuilder.create().texOffs(96, 16).addBox(-1.0F, -2.0F, -2.0F, 4.0F, 5.0F, 4.0F, new CubeDeformation(1.0F)), PartPose.offsetAndRotation(-3.5F, 11.0F, 0.0F, 0.0F, 0.0F, 0.2182F));

		PartDefinition jacket_r3 = jacket.addOrReplaceChild("jacket_r3", CubeListBuilder.create().texOffs(96, 16).mirror().addBox(-3.0F, -2.0F, -2.0F, 4.0F, 5.0F, 4.0F, new CubeDeformation(1.0F)).mirror(false), PartPose.offsetAndRotation(3.5F, 11.0F, 0.0F, 0.0F, 0.0F, -0.2182F));
		...
		PartDefinition left_arm_r1 = left_arm.addOrReplaceChild("left_arm_r1", CubeListBuilder.create().texOffs(112, 8).addBox(-2.0F, -2.0F, -2.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(1.15F)), PartPose.offsetAndRotation(1.4848F, -0.6736F, 0.0F, 0.0F, 0.0F, -0.3927F));
		...
		PartDefinition right_arm_r1 = right_arm.addOrReplaceChild("right_arm_r1", CubeListBuilder.create().texOffs(96, 8).addBox(-2.0F, -2.0F, -2.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(1.15F)), PartPose.offsetAndRotation(-1.5F, -0.5F, 0.0F, 0.0F, 0.0F, 0.3927F));
	...
	public Modelblack_gold_warrior_armor getArmor(LivingEntity entity){
		return this;
	}
