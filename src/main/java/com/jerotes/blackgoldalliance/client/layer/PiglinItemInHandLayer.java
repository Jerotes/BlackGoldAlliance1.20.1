...
public class PiglinItemInHandLayer<T extends LivingEntity, M extends Modelspecial_action<T>> extends RenderLayer<T, M> {
    private final ItemInHandRenderer itemInHandRenderer;

    public PiglinItemInHandLayer(RenderLayerParent<T, M> renderLayerParent, ItemInHandRenderer itemInHandRenderer) {
    ...
    public void render(PoseStack poseStack, MultiBufferSource multiBufferSource, int n, T t, float f, float f2, float f3, float f4, float f5, float f6) {
        ...
        if (!$$11.isEmpty() || !$$12.isEmpty()) {
            ...
            if (t.getMainHandItem().getItem() == BGAItems.THE_BLACK_GOLD_MARSHAL_GREATSWORD.get() && t instanceof TheBlackGoldMarshalEntity) {
                poseStack.popPose();
                return;
            }
    ...
    protected void renderArmWithItem(LivingEntity p_117185_, ItemStack p_117186_, ItemDisplayContext p_270970_, HumanoidArm p_117188_, PoseStack p_117189_, MultiBufferSource p_117190_, int p_117191_) {
        if (!p_117186_.isEmpty()) {
            p_117189_.pushPose();
            if (p_117186_.getItem() instanceof BlackGoldShamanStaff) {
                ...
                p_117189_.translate(0, 1/16f * 2.75, -1/16f * 1.5);
            ...
            else  if (!(p_117186_.getItem() instanceof ItemToolBaseSpearBase itemToolBaseSpearBase && !itemToolBaseSpearBase.otherAnimSpear())) {
                ((ArmedModel) this.getParentModel()).translateToHand(p_117188_, p_117189_);
                p_117189_.mulPose(Axis.XP.rotationDegrees(-90.0F));
                p_117189_.mulPose(Axis.YP.rotationDegrees(180.0F));
                boolean $$7 = p_117188_ == HumanoidArm.LEFT;
                ...
                this.getParentModel().translateToHandOld(p_117188_, p_117189_);
                p_117189_.mulPose(Axis.XP.rotationDegrees(-90.0F));
                p_117189_.mulPose(Axis.YP.rotationDegrees(180.0F));
                boolean $$7 = p_117188_ == HumanoidArm.LEFT;
