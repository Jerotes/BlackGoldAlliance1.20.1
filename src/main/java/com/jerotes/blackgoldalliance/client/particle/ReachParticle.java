package com.jerotes.blackgoldalliance.client.particle;

import com.jerotes.blackgoldalliance.init.BGAParticleRenderTypes;
...
@OnlyIn(Dist.CLIENT)
public class ReachParticle extends TextureSheetParticle {
	...
	public static class DisplayParticleProvider implements ParticleProvider<SimpleParticleType> {
		...
		public Particle createParticle(SimpleParticleType typeIn, ClientLevel worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
			return new ReachParticle(worldIn, x, y, z, xSpeed, ySpeed, zSpeed, this.spriteSet);
		}
	}

	private final SpriteSet spriteSet;

	protected ReachParticle(ClientLevel world, double x, double y, double z, double vx, double vy, double vz, SpriteSet spriteSet) {
		super(world, x, y, z);
		this.spriteSet = spriteSet;
		this.setSize(1f, 1f);
		this.quadSize = 2f;
	...
	public ParticleRenderType getRenderType() {
		return BGAParticleRenderTypes.CUSTOM_TRANSLUCENT_SHOCKWAVE;
	}
